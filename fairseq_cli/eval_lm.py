...
def main(parsed_args, **unused_kwargs):
    ...
    # if parsed_args.model_overrides == '{}':
    #     parsed_args.model_overrides = "{\"load_knn_datastore\": True, \"use_weights\": False,  \"use_knn_datastore\": True,\"dstore_filename\": \"/apdcephfs/share_916081/dirkiedai/datastore/wikitext-lm/RS/dsize-10322548\",\"faiss_index\":\"/apdcephfs/share_916081/dirkiedai/datastore/wikitext-lm/RS/dsize-10322548/knn_index\" ,\"dstore_size\": 10322548, \"dstore_fp16\": True, \"k\": 8, \"probe\": 32,\"knn_sim_func\": \"do_not_recomp_l2\", \"use_gpu_to_search\": True, \"move_dstore_to_mem\": True, \"no_load_keys\": True,\"knn_lambda_type\": \"trainable\",  \"knn_lambda_value\": 0.2, \"knn_temperature_type\": \"fix\", \"knn_temperature_value\": 10,}"
    #Load ensemble
