...
def get_save_datastore_lm_parser(default_task=None):
    # add by zx, just copy from get_validation_parser
    # and add datastore args
...
def add_generation_args(parser):
    ...
    group.add_argument('--prefix-constrained', action='store_true',
                       help='if set, uses prefix-constrained beam search iteratively')
    ...
    #arguments for edit distance
    group.add_argument('--unicost', default=False, action='store_true')
    group.add_argument('--ed_tokenizer', type=str, default="none", 
                        help='tokenizer')
    group.add_argument('--ed_lowercase', default=False, action='store_true')
    group.add_argument('--ed_char_level',default=False, help='number of centroids faiss should learn')
    group.add_argument('--ed_remove_punct', default=False, action='store_true')

    #arguments for interactive knn-mt
    group.add_argument('--nround', default=1, type = int,metavar='N', help='round of inference')
    group.add_argument('--clear-datastore', default=False, action='store_true')
    group.add_argument('--quick-add-datastore', default=False, action='store_true')
